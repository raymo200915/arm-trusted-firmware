...
#define PLAT_QEMU_DTO_BASE		PLAT_QEMU_DT_BASE + PLAT_QEMU_DT_MAX_SIZE
#define PLAT_QEMU_DTO_MAX_SIZE		0x1000
...
#define REALM_DRAM_BASE			(NS_DRAM0_BASE + PLAT_QEMU_DT_MAX_SIZE + PLAT_QEMU_DTO_MAX_SIZE)
